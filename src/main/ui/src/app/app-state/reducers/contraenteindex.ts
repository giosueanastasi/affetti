...
import * as fromCreateContraente from './createcontraente';
...
export const getCreateContraenteState = createFeatureSelector<fromCreateContraente.State>('createContraente');

export const getContraenti = createSelector(
  getCreateContraenteState,
  fromCreateContraente.getContraenti
);
